    ...
    return (
        <View>
            ...
            <View style={[styles.divTop]}>
                <Text style={{ fontSize: 20, color: '#ffff', fontWeight: 600 }}> {myIcon}DebugQr_Scaner</Text>
                <TouchableOpacity style={styles.buttonTouchable} onPress={() => setflash(!flash)} >
                    <Text style={{ fontSize: 20, color: '#fff' }}>{flash ? <Icon name="flash-off" size={20} color="#fff" /> : <Icon name="flash" size={21} color="#003" />}</Text>
                </TouchableOpacity>
            </View>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <Text style={{ textAlign: 'center', marginTop: 30, color: '#F4D9E7' }}> Developed : Debugger</Text>
                    </View>
                </View>
            </Modal>
        </View>
